...
static void payload_version_check(void *arg)
{
  ...
  if ((pfdi_version.x1 != 0) || (pfdi_version.x2 != 0) ||
    ...
    val_print(ERROR, " x1=0x%llx", pfdi_version.x1);
    val_print(ERROR, " x2=0x%llx", pfdi_version.x2);
    val_print(ERROR, " x3=0x%llx", pfdi_version.x3);
    val_print(ERROR, " x4=0x%llx", pfdi_version.x4);
